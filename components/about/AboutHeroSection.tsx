        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-8 max-w-xl text-base leading-relaxed text-slate-600">
              ...
              institutional-grade quantitative execution. Our mission is to make
              disciplined, mathematically structured trading systems accessible
              beyond closed enterprise environments.
            </p>
